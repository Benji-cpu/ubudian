...
export async function GET(request: Request) {
  ...
  // Running retries first ensures they aren't starved by long-running source fetches.
  ...
  // --- Phase 2: Run source ingestion for due sources ---
  ...
  const dueSources = sources
    ...
    // Sort by staleness: sources that haven't run longest get priority
    .sort((a, b) => {
