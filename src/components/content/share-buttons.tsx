...
interface ShareButtonsProps {
  title: string;
  url: string;
  /** Optional teaser used by Twitter/Telegram/Web Share for richer context. */
  text?: string;
}
...
export function ShareButtons({ title, url, text }: ShareButtonsProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      {canNativeShare && (
        <Button variant="outline" size="sm" onClick={nativeShare} className="md:hidden">
      ...
      <Button variant="outline" size="sm" onClick={shareInstagram} aria-label="Share on Instagram (copies link)">
        {instaCopied ? (
          <>
